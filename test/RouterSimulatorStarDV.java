...
/*
 * Anillo de 6
 * se aisla un nodo y se conecta la otra parte del anillo
 * 
 *
 */
...
******************************************************************/
  ...
  RouterSimulator()                         /* initialize the simulator */
  {
    ...
    nodes = new RouterNodeDV[NUM_NODES];
    for(int i=0; i<NUM_NODES; i++){
      ...
      nodes[i] = new RouterNodeDV(i, this, neighbors);
    }
